...
- `mamba2-vs-gated-deltanet.ipynb` — MLX walkthrough contrasting a toy Mamba-2 selective SSM block with Qwen 3 Next's gated DeltaNet, including mathematical notes and side-by-side activations.
